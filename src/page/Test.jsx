...
const Section = () => {
  ...
  <div>
    ...
    <br/>
    <span onClick={scrollToBottom}>To the bottom!</span>
    <br/>
    <span onClick={scrollTo}>Scroll to 100px from the top</span>
    <br/>
    <span onClick={scrollMore}>Scroll 100px more from the current position!</span> */}
  </div>
);
